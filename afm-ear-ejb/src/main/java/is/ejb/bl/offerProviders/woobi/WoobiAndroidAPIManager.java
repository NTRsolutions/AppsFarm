...
import is.ejb.bl.offerProviders.woobi.getAndroidOffers.OffersEntry;
import is.ejb.bl.offerProviders.woobi.getAndroidOffers.WoobiAndroidGetOffers;
...
public class WoobiAndroidAPIManager {
	...
	public ArrayList<Offer> getOffers(OfferWallEntity offerWall,
		...
		Application.getElasticSearchLogger().indexLog(Application.OFFER_WALL_GENERATION_ACTIVITY, 
				...
				OfferProviderCodeNames.WOOBI_ANDROID+" requesting url: "+requestUrl);
    	...
    	ArrayList<is.ejb.bl.offerWall.content.Offer> listSelectedIndividualOffers = new ArrayList<is.ejb.bl.offerWall.content.Offer>(); 
     	...
     	try {
			...
			WoobiAndroidGetOffers offersHolder = mapper.readValue(reqResponse, WoobiAndroidGetOffers.class);
            ...
            Application.getElasticSearchLogger().indexLog(Application.OFFER_WALL_GENERATION_ACTIVITY, 
    				...
    				OfferProviderCodeNames.WOOBI_ANDROID+" offer pool size: "+ listPulledOffers.size());//+" rest method called, content: "+requestUrl);
            //update offer stats
    		...
    		logger.info(OfferProviderCodeNames.WOOBI_ANDROID+" total pulled offers: "+listPulledOffers.size());
    		...
    		while(listSelectedIndividualOffers.size() < (numberOfOffersToSelect)) {
    			if(listPulledOffers.size() == 0) {
    				Application.getElasticSearchLogger().indexLog(Application.OFFER_WALL_GENERATION_ACTIVITY, 
    						offerWall.getRealm().getId(), 
    						LogStatus.WARNING, 
    						Application.OFFERS_GENERATION_OFFERS_INSUFFICIENT+" "+OfferProviderCodeNames.WOOBI_ANDROID+
            	...
            	offerToAdd.setAdProviderCodeName(OfferProviderCodeNames.WOOBI_ANDROID.toString());
				...
				//removed as some of below were null (which caused no images to be displayed in the feed)
    			...
    			isOfferAcceptedByGlobalFilter = offerFilterManager.isOfferAcceptedBasedOnGlobalFilters(offerToAdd, offerWall, OfferProviderCodeNames.WOOBI_ANDROID);
    			if(isOfferAcceptedByGlobalFilter) {
    				isOfferAcceptedByGeoFilter = offerFilterManager.isOfferAcceptedBasedOnGeoFilter(offerToAdd, 
    							offerWall, 
    							OfferProviderCodeNames.WOOBI_ANDROID, 
    			...
    			if(offerFilterManager.getOfferFilterConfiguration().isRejectDuplicateOffers()) { //if filter for rejecting duplicate offers is enabled - trigger it
        			if(isOfferAcceptedByGlobalFilter && 
        				...
        				offerToAdd = offerRewardCalculationManager.calculateOfferReward(offerToAdd, offerWall, OfferProviderCodeNames.WOOBI_ANDROID);
    			...
    			if(isOfferAcceptedByGlobalFilter && 
    				...
    				Application.getElasticSearchLogger().indexLog(Application.OFFER_WALL_GENERATION_ACTIVITY, 
    						...
    						OfferProviderCodeNames.WOOBI_ANDROID+" successfully created offer "
            ...
            throw new Exception(OfferProviderCodeNames.WOOBI_ANDROID+
