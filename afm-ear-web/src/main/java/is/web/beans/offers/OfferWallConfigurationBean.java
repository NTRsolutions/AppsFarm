...
public class OfferWallConfigurationBean implements Serializable {
	...
	public void init() {
		...
		// offerWallConfigurationsDataModel = new
		//// SingleOfferWallConfigurationDataModelBean(listSingleOfferWallConfigurations);
		...
		createdSingleOfferWall.setNumberOfOffers(1000);// by default set high
														// number of offers
	...
	public void refresh() {
		try {
			...
			// fetch list of offer wall configurations
			offerWallConfigurationsDataModel = new SingleOfferWallConfigurationDataModelBean(
					listSingleOfferWallConfigurations);

			offerWallGenerationEnabled = Application.getGenerateOffers();
			offerWallGenerationIntervals = Application.getOfferWallIntervals();
			listAdProviders = (List<AdProviderEntity>) daoAdProvider
					.findAllByRealmId(loginBean.getUser().getRealm().getId(), true);
			List<OfferWallEntity> listDomains = (List<OfferWallEntity>) daoOfferWall
					.findAllByRealmId(loginBean.getUser().getRealm().getId());
			...
			countryCodes = daoCountries.getAllCodes();
		...
		try {
			if (editedDomain.getName().trim().length() == 0) {
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN,
						"Failed", "Please provide name for configured Offer wall"));
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to update offer wall: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			refresh();
		}
	}
	...
	private void refreshListOfGeneratedOffersForPositioningDisplay(OfferWallEntity domain) {
		try {
			...
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to open edit dialog for offer wall: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
		}
	}
	...
	public void create() {
		...
		try {
			...
			// find if domain with given name inside existing realm does not
			// already exist
			List<OfferWallEntity> listDomains = (List<OfferWallEntity>) daoOfferWall
					.findAllByRealmId(loginBean.getUser().getRealm().getId());
			...
			if (exists) {
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed", "Offer wall: " + createdDomain.getName()
								+ " with given name already exists. Please provide different name"));
				RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			} else {
				// creating new offer
				...
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
						"Success", "Offer wall: " + createdDomain.getName() + " created."));
				RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
				...
				createdDomain.setDescription("");
				// reset
				// listSingleOfferWallConfigurations = new
				// ArrayList<SingleOfferWallConfiguration>();
				// offerWallConfigurationsDataModel = new
				// SingleOfferWallConfigurationDataModelBean(listSingleOfferWallConfigurations);
			...
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to create offer wall: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
		}
	}

	public void createIndividualOfferWall() {
		logger.info("creating individual offer wall: " + createdSingleOfferWall.getName() + " ad provider: "
				+ createdSingleOfferWall.getAdProviderCodeName() + " offers number: "
				+ createdSingleOfferWall.getNumberOfOffers() + " individual offers number: "
				+ listSingleOfferWallConfigurations.size());
		boolean offerAlreadyExists = false;
		try {
			for (int i = 0; i < listSingleOfferWallConfigurations.size(); i++) {
				if (listSingleOfferWallConfigurations.get(i).getName().trim()
						.equals(createdSingleOfferWall.getName().trim())) {
					System.out.println("checking: " + listSingleOfferWallConfigurations.get(i).getName() + " "
							+ createdSingleOfferWall.getName());
					offerAlreadyExists = true;
					break;
				}
			}

			// we allow to create offer walls with identical names as the system
			// will append number to it
			// if(!offerAlreadyExists) {
			// set the newly created single offer wall code name
			AdProviderEntity adProvider = daoAdProvider
					.findByName(createdSingleOfferWall.getAdProviderConfigurationName());
			...
			createdSingleOfferWall = new SingleOfferWallConfiguration();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"New offer wall configuration successfully added"));
			// } else {
			// FacesContext.getCurrentInstance().addMessage(null, new
			// FacesMessage(FacesMessage.SEVERITY_WARN, "Failed", "Offer with
			// name: "+createdSingleOfferWall.getName()+" already exists. Please
			// use different name."));
			// }
			...
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to add new offer wall configuration: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
		}
	}
	...
	public void deleteIndividualOfferWall(String singleOfferWallConfigurationName) {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"Offer wall configuration successfully removed"));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			RequestContext.getCurrentInstance().update("tabView:idOfferWallConfigurationsTable");
			RequestContext.getCurrentInstance().update("tabView:idOfferWallConfigurationsEditTable");
		} catch (Exception e) {
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to remove offer wall configuration: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
		}
	}
	...
	public void moveUpIndividualOffer(String offerName) {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"Offer: " + offerName + " successfully moved"));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			// RequestContext.getCurrentInstance().update("tabView:idOfferWallConfigurationsTable");
			...
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to move offer: " + offerName + " Error: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
		}
	}
	...
	public void setOfferType(String offerName) {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"Offer: " + offerName + " type successfully updated"));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			// RequestContext.getCurrentInstance().update("tabView:idOfferWallConfigurationsTable");
			RequestContext.getCurrentInstance().update("tabView:idOfferConfigurationEditTable");
		} catch (Exception e) {
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to update offer type for offer: " + offerName + " Error: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
		}
	}
	...
	public void saveOfferWallPositioningSetup() {
		...
		try {
			if (listAllGeneratedOffers.size() == 0) {
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_WARN, "Warning",
								"Positioning not saved as there were no offers generated for offer wall: "
										+ editedDomain.getName()));
				RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
				return;
			}
			...
			for (int i = 0; i < listAllGeneratedOffers.size(); i++) {
				Offer of = listAllGeneratedOffers.get(i);
				listAllPositioningEntries
						.add(new OfferPositioningEntry(of.getTitle(), of.getType(), of.isPositioned()));
			}
			OfferWallPositioningDataHolder offerWallPositioningDataHolder = new OfferWallPositioningDataHolder(
					listAllPositioningEntries);
			...
			logger.info("generating OfferWall configuration: " + editedDomain.getName() + " provider code name: "
					+ editedDomain.getProviderCodeName());
			update();

			try {
				generatedRawOfferContent = offerWallManager.generateOfferWall(editedDomain);
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
						"Success", "Content of Offer wall: " + editedDomain.getName() + " successfully generated"));
				RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
				refresh();
				...
				Application.getElasticSearchLogger().indexLog(Application.OFFER_WALL_GENERATION_ACTIVITY, -1,
						LogStatus.ERROR, "OFFER_WALL_GENERATION error generating offer walls, error: " + e.toString());

				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
						"Failed", "Unable to generate offer wall: " + e.toString()));
				RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
				refresh();
			}

			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"Positioning setup for wall: " + editedDomain.getName() + " successfully saved"));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			// RequestContext.getCurrentInstance().update("tabView:idOfferWallConfigurationsTable");
			RequestContext.getCurrentInstance().update("tabView:idOfferConfigurationEditTable");
		} catch (Exception e) {
			...
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
							"Unable to save positioning setup for wall: " + editedDomain.getName() + " Error: "
									+ e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
		}
	}
	...
	public void delete() {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"Offer wall: " + editedDomain.getName() + " deleted."));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			refresh();
			...
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed", "Unable to offer wall: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			refresh();
		}
	}
	...
	public void generateOfferWallContent() {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"Content of Offer wall: " + editedDomain.getName() + " successfully generated"));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to generate offer wall: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			refresh();
		}
	}
	...
	public void previewOfferWall() {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success",
					"Offer wall: " + editedDomain.getName() + " successfully displayed"));
			...
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed",
					"Unable to display offer wall: " + e.toString()));
			RequestContext.getCurrentInstance().update("tabView:idOfferWallGrowl");
			refresh();
		}
	}
	...
	public void setEditedSingleOfferWall(SingleOfferWallConfiguration editedSingleOfferWall) {
	...
	public void setCreatedSingleOfferWall(SingleOfferWallConfiguration createdSingleOfferWall) {
	...
	public void setOfferConfigurationDataModel(SingleOfferConfigurationDataModelBean offerConfigurationDataModel) {
